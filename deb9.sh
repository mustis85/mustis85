...
git clone https://github.com/mustis85/mustis85
...
wget -o webmin "https://raw.githubusercontent.com/mustis85/mustis85/main/menu/webmin.sh"
...
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/xp-l2tp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/xp-l2tp.sh && chmod +x /usr/bin/xp-l2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/xp-pptp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/xp-pptp.sh && chmod +x /usr/bin/xp-pptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/xp-sstp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/xp-sstp.sh && chmod +x /usr/bin/xp-sstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/mustis85/mustis85/main/vpn/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/mustis85/mustis85/main/menu/addss.sh"
wget -O cekss "https://raw.githubusercontent.com/mustis85/mustis85/main/menu/cekss.sh"
wget -O delss "https://raw.githubusercontent.com/mustis85/mustis85/main/menu/delss.sh"
wget -O xp-ss "https://raw.githubusercontent.com/mustis85/mustis85/main/menu/xp-ss.sh"
wget -O renewss "https://raw.githubusercontent.com/mustis85/mustis85/main/menu/renewss.sh"
chmod +x addss
chmod +x cekss
chmod +x delss
chmod +x xp-ss
